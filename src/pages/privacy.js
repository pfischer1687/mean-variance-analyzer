      ...
      <div className={styles.textContainer}>
        ...
        <p>
          <i>
            ...
            who advertise on our Services, but are not affiliated with, our
            Services.
          </i>
        </p>
        <p>
        ...
        <p>
          We do not use cookies and similar tracking technologies (like web
        ...
        <p>
          Our Services do not offer you the ability to register and log in using
        ...
        <p>
          The site is hosted on the website hosting service provider listed
          above, which has servers located in different countries. Please refer
          to the link above for more information. If you are accessing our
          Services from outside such countires, please be aware that your
          ...
          PERSONAL INFORMATION?” above), in countries where Third-Party Servers
          are Located, and other countries.
        </p>
        <p>
        ...
        <p>
          ...
          period of time in which users are using the Site.
        </p>
        <p>
        ...
        <p>
          We have not collected personal information in the past twelve (12)
          months.
        </p>
        {/* Category 	Examples 	Collected */}
        <p>
          We may collect other personal information in instances where you
          interact with us in person, online, or by phone or mail in the context
          of:
        </p>
        <ul>
